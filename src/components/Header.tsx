      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 justify-between">
          <div className="flex">
            ...
            <div className="hidden md:flex space-x-7 ml-10 -my-px">
              {/* <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" --> */}
              <a
                href="#"
                className="text-gray-900 hover:text-gray-700 border-b-2 hover:border-gray-300 border-transparent text-md inline-flex items-center font-medium pt-1 px-1"
                aria-current="page"
              >
                Dashboard
              </a>
              <a
                href="#"
                className="text-gray-900 hover:text-gray-700 border-b-2 hover:border-gray-300 border-transparent text-md inline-flex items-center font-medium"
              >
                Team
              </a>
              <a
